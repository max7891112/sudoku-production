...
var InputNumber = /*#__PURE__*/function () {
  ...
  _createClass(InputNumber, [{
    ...
    value: function listenerForLevelButtons() {
      var easy = document.querySelectorAll('[data-level="easy"]');
      var medium = document.querySelectorAll('[data-level="medium"]');
      var hard = document.querySelectorAll('[data-level="hard"]');
      var buttons = document.querySelectorAll('[data-level]');
      console.log(buttons);
      var tds = document.querySelectorAll('td');
      var _iterator6 = _createForOfIteratorHelper(easy),
        _step6;
      try {
        for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
          var button = _step6.value;
          button.addEventListener('click', function () {
            var _iterator9 = _createForOfIteratorHelper(tds),
              _step9;
            try {
      ...
      var _iterator7 = _createForOfIteratorHelper(medium),
        _step7;
      try {
        for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
          var _button2 = _step7.value;
          _button2.addEventListener('click', function () {
            var _iterator11 = _createForOfIteratorHelper(tds),
              _step11;
            try {
            ...
            var answer = confirm('the progress of the current game will be lost');
            if (answer) {
              var _iterator12 = _createForOfIteratorHelper(buttons),
                _step12;
              try {
                for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
                  var _button3 = _step12.value;
                  _button3.classList.remove('active');
                }
              } catch (err) {
                _iterator12.e(err);
              } finally {
      ...
      var _iterator8 = _createForOfIteratorHelper(hard),
        _step8;
      try {
        for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
          var _button4 = _step8.value;
          _button4.addEventListener('click', function () {
            var _iterator13 = _createForOfIteratorHelper(tds),
              _step13;
            try {
            ...
            if (answer) {
              ...
              try {
                for (_iterator14.s(); !(_step14 = _iterator14.n()).done;) {
                  var _button5 = _step14.value;
                  _button5.classList.remove('active');
                }
              } catch (err) {
                _iterator14.e(err);
              } finally {
    ...
    value: function listenerForNewGame(level) {
      ...
      newGameBtn.addEventListener('click', function () {
        var _iterator15 = _createForOfIteratorHelper(tds),
          _step15;
        try {
...
},{"./components/sudoku/renderGameField.js":"xTqK","./components/sudoku/Sudoku.js":"e7Bj","./components/InputNumber/InputNumber.js":"TMVZ"}]},{},["Focm"], null)